...
import { callShopify, ProductSlugs, singleProduct } from "../../helpers/shopify"
  ...
  return (
    ...
    >
      ...
      <div className="pt-2 px-0 md:px-10 pb-8 w-full md:w-1/2">
        ...
        <button
          className="text-sm tracking-wider text-white font-semibold py-4 px-12 border-2 border-black hover:border-transparent w-full"
          onClick={checkout}
        >
          {isLoading && (
...
export async function getStaticPaths() {
  const response = await callShopify(ProductSlugs)
